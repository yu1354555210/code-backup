    ...
    c.prototype.view = function() {
        ...
        var l = function() {
            ...
            c = function() {
                ...
                console.log(t);
                if(t==1){
                    return 0 !== t && n.btn ? (e = '<span yes type="1" class="aui-btn aui-btn-danger aui-btn-block aui-btn-outlined aui-btn-sm" style="margin: auto;border-radius: 2.5rem;width:30%;">' + n.btn[0] + "</span>", 2 === t && (e = '<span no type="0" class="aui-btn aui-btn-danger aui-btn-block aui-btn-outlined aui-btn-sm" style="margin: auto;border-radius: 2.5rem;width:70%;">' + n.btn[1] + "</span>" + e), '<div class="layui-m-layerbtn">' + e + "</div>") : ""
                }else if (t!=1) {
                    return 0 !== t && n.btn ? (e = '<span yes type="1" class="aui-btn aui-btn-danger aui-btn-block aui-btn-sm" style="margin: auto;border-radius: 2.5rem;width:70%;height:30px;line-height:30px;">' + n.btn[0] + "</span>", 2 === t && (e = '<span no type="0" class="aui-btn aui-btn-danger aui-btn-block aui-btn-outlined aui-btn-sm" style="margin: auto;border-radius: 2.5rem;width:70%;height:28px;line-height:28px;">' + n.btn[1] + "</span>" + e), '<div class="layui-m-layerbtn">' + e + "</div>") : ""
                }
            }();
        if(n.fixed || (n.top = n.hasOwnProperty("top") ? n.top : 100, n.style = n.style || "", n.style += " top:" + (t.body.scrollTop + n.top) + "px"), 2 === n.type && (n.content = '<i></i><i class="layui-m-layerload"></i><i></i><p>' + (n.content || "") + "</p>"), n.skin && (n.anim = "up"), "msg" === n.skin && (n.shade = !1), s.innerHTML = (n.shade ? "<div " + ("string" == typeof n.shade ? 'style="' + n.shade + '"' : "") + ' class="layui-m-layershade"></div>' : "") + '<div class="layui-m-layermain" ' + (n.fixed ? "" : 'style="position:static;"') + '><div class="layui-m-layersection"><div class="layui-m-layerchild ' + (n.skin ? "layui-m-layer-" + n.skin + " " : "") + (n.className ? n.className : "") + " " + (n.anim ? "layui-m-anim-" + n.anim : "") + '" ' + (n.style ? 'style="' + n.style + '"' : "") + ">" + l + '<div class="layui-m-layercont">' + n.content + "</div>" + c + "</div></div></div>", !n.type || 2 === n.type) {
            var d = t[i](o[0] + n.type),
                y = d.length;
            y >= 1 && layer1.close(d[0].getAttribute("index"))
        }
        ...
        e.time && (l.timer[n.index] = setTimeout(function() {
            layer1.close(n.index)
        }, 1e3 * e.time));
        var a = function() {
            var t = this.getAttribute("type");
            0 == t ? (e.no && e.no(), layer1.close(n.index)) : e.yes ? e.yes(n.index) : layer1.close(n.index)
        };
        if(e.btn)
        ...
        closeAll: function() {
            for(var e = t[i](o[0]), n = 0, a = e.length; n < a; n++) layer1.close(0 | e[0].getAttribute("index"))
        }
