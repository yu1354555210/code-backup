<template>
	<view class="detail">
		...
		<view class="detail-content">
			<view class="detail-html"><gaoyia-parse :content="formData.content" :noData="noData"></gaoyia-parse></view>
		...
		<view class="detail-bottom">
			...
			<view class="detail-bottom__icons">
				...
				<view class="detail-bottom__icons-box" @click="likeTap(formData._id)"><uni-icons :type="formData.is_like ? 'heart-filled' : 'heart'" size="22" color="#F07373"></uni-icons></view>
				<view class="detail-bottom__icons-box" @click="thumbsup(formData._id)"><uni-icons :type="formData.is_thumbs_up?'hand-thumbsup-filled':'hand-thumbsup'" size="22" color="#F07373"></uni-icons></view>
			</view>
		</view>
		...
		<uni-popup type="bottom" ref="popup" :maskClick="false">
			<view class="popup-wrap">
				...
				<view class="popup-content">
					<textarea value="" fixed class="popup-textarea" v-model="comentsValue" placeholder="请输入评论内容" maxlength="200" />
					<view class="popup-count">{{ comentsValue.length }}/200</view>
				</view>
			</view>
		</uni-popup>
	</view>
...
<script>
import gaoyiaParse from '@/components/gaoyia-parse/parse.vue';
export default {
	data() {
		return {
			formData: {},
