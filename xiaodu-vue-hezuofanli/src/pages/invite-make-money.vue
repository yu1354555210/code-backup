    ...
    <mescroll-vue ref="mescroll" :down="mescrollDown" :up="mescrollUp">
      ...
      <div class="invite-make-money-content">
        ...
        <div class="invite-card">
          <div class="invite-title invite-title-yqhy">
            <img src="../assets/images/title-yqhy.png" alt="">
          </div>
        ...
        <div v-for="item in channel" v-if="item.id==xch_id">
          <div class="invite-card">
            <div class="invite-title invite-title-gxyq">
              <img src="../assets/images/title-gxyq.png" alt="">
            </div>
            <div class="invite-info">邀请你的好友来平台，TA在任意游戏充值都给你返利</div>
            <div class="invite-card-btn invite-card-long-btn">
              <x-button @click.native="toXdQrcode(item.link)" class="radius">立即邀请</x-button>
            </div>
          </div>
          <div class="invite-card">
            <div class="invite-title invite-title-yxyq">
              <img src="../assets/images/title-yxyq.png" alt="">
            </div>
            ...
            <ul class="invite-game-list">
              <li v-for="game in item.games">
                ...
                <div class="invite-card-btn">
                  <x-button class="radius" @click.native="toGxQrcode(game)">立即邀请</x-button>
                </div>
              </li>
            </ul>
          </div>
