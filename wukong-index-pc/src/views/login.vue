  ...
  <div class="wrapper">
    ...
    <div class="login-section">
      <div class="this-input">
        <i class="icon-user"></i>
        <input type="text" name="" placeholder="请输入游戏UID" v-model="username" />
      </div>
     <!-- <div class="this-input">
        <i class="icon-pwd"></i>
     ...
     <!-- <div class="form-other">
      ...
      <div class="rule">
        <dl>
          ...
          <dd>★游戏UID请联系客服提供账号即可查询~</dd>
          <dd>★请点击右上角，选择浏览器打开才能正常使用~</dd>
        </dl>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  export default {
    ...
    methods: {
      ...
      postLogin() {
        if(this.username == ''){
          this.$vux.toast.text("请输入游戏UID");
          return;
        }
        this.changeLogin(true);
        this.setUserInfo(this.username);
        // this.setToken(data.token);
        // this.setUid(this.username);
        location.href = 'https://h5-ios.duobaoyu.fun/wukong-android/';
        // if(this.password == ''){
