	...
	<div class="bg_whife">
		<div id="win_wrap" class="wrapper bg_grey">
			...
			<group :gutter="0" class="add_group">
				...
				<x-address title="所在地区:" raw-value required :list="addressData" placeholder="请选择所在地区" id="receiveaddr" v-model="addressVal"></x-address>
				<x-textarea title="详细地址:" required id="receiveaddrarea" :autosize="true" v-model="addrInfo"></x-textarea>
				<x-switch title="设为默认:" v-show="isShowDefault == 0" :value-map="['0', '1']" v-model="isDefault"></x-switch>
			</group>
	...
	export default {
		...
		mounted: function() {
			...
			$("#saveaddress").click(function() {
				...
				var receiveaddrInfo = self.addrInfo;
